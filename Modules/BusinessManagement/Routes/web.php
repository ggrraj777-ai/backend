...
use Modules\BusinessManagement\Http\Controllers\Web\Admin\BusinessSetup\FareCalculationController;
...
//                    Route::post('store-max-parcel-request-accept-limit', 'storeMaxParcelRequestAcceptLimit')->name('storeMaxParcelRequestAcceptLimit');
            ...
            Route::group(['prefix' => 'fare-calculation', 'as' => 'fare-calculation.'], function () {
                Route::controller(FareCalculationController::class)->group(function () {
                    Route::get('/', 'index')->name('index');
                    Route::post('store', 'store')->name('store');
                });
            });
