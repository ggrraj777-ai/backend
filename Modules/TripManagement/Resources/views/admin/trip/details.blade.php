                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="px-xl-3">
                                            <dl class="data-list gy-2 text-dark">
                                                ...
                                                <dt class="border-top pt-3"><strong>{{ translate('fare_breakdown') }}</strong></dt>
                                                <dd class="m-0">
                                                    <?php
                                                        $fareBase = $trip->actual_fare ?? $trip->estimated_fare ?? 0;
                                                        $fb = calculateFareBreakdown($fareBase);
                                                    ?>
                                                    <div class="table-responsive mt-2">
                                                        <table class="table table-sm align-middle">
                                                            <tbody>
                                                            <tr>
                                                                <th class="w-50">{{ translate('Fare value') }}</th>
                                                                <td>{{ set_currency_symbol($fb['fare']) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ translate('GST (Ride)') }} ({{ $fb['settings']['gst_on_ride_percent'] }}%)</th>
                                                                <td>{{ set_currency_symbol($fb['gst_on_ride']) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ translate('Platform Fee') }} ({{ $fb['settings']['platform_fee_type'] == 'percent' ? $fb['settings']['platform_fee_value'].'%' : translate('flat') }})</th>
                                                                <td>{{ set_currency_symbol($fb['platform_fee_base']) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ translate('GST on Platform Fee') }} ({{ $fb['settings']['gst_on_fee_percent'] }}%)</th>
                                                                <td>{{ set_currency_symbol($fb['platform_fee_gst']) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ translate('Cashback') }} ({{ $fb['settings']['cashback_percent'] }}%)</th>
                                                                <td>-{{ set_currency_symbol($fb['cashback']) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ translate('Total paid by customer') }}</th>
                                                                <td>{{ set_currency_symbol($fb['customer_pays']) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ translate('Driver receives') }}</th>
                                                                <td>{{ set_currency_symbol($fb['driver_receives']) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>{{ translate('Gauva final balance') }}</th>
                                                                <td>{{ set_currency_symbol($fb['gauva_balance']) }}</td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
